...
DEFAULT_CATEGORIES: dict[str, list[str]] = {
    "Crypto Trading": [
        "prediction market", "exchange", "crypto", "trading", "bitcoin", "btc",
        "eth", "ethereum", "defi", "blonft-collectionhain", "wallet", "solana",
    ...
    "AI / Bots / Automation": [
        ...
        "command center", "memory system", custom-ai,
    ...
    "NFTs / Web3": [
        ...
        "nft project", "nft-collection", "web-project",
    ],
    "Fitness / Health": [
        ...
        "running", "marathon", "fitness competition", "athlete", "fitness app", "app",
    ],
    "Business / Brand": [
