...
CATEGORY_META: dict[str, dict] = {
    "Crypto Trading": {
        ...
        "themes": ["LTR", "Liquidity Trap Reversal", "Hyperliquid", "Polymarket", "orderflow",
                   "hedge fund", "futures", "Coreflow", "AVWAP", "FVG", "NinjaTrader", "Bookmap"],
    },
    "AI / Bots / Automation": {
        "callout": "ai-bots",
        "label": "AI / Bots / Automation",
        "themes": ["Claude", "MCP", "Command Center", "automation", "agents",
                   "n8n", "Kaizen", "AI council", "Dragonfruit", "local AI"],
    },
    "NFTs / Web3": {
        "callout": "web3",
        "label": "NFTs / Web3",
        "themes": ["Crypto Kennel Club", "CKC", "smart contract", "DAO",
                   "Solidity", "OpenSea", "KAIJU SYNDICATE trademark", "DePIN"],
    },
    "Flutter / Mobile": {
        "callout": "flutter",
        "label": "Flutter / Mobile Apps",
        "themes": ["MTH", "More Than Human", "Flutter", "Dart",
                   "hybrid athlete", "workout tracking", "Odyssey"],
    },
    "Web Development": {
        "callout": "webdev",
        "label": "Web Development",
        "themes": ["React", "Next.js", "KINGSWITCH", "landing page",
                   "3D scroll", "website", "Three.js"],
    },
    "Fitness / Health": {
        "callout": "fitness",
        "label": "Fitness / Health",
        "themes": ["NSCA", "Hyrox", "biohacking", "hybrid athlete",
                   "nutrition", "supplement stack", "More Than Human"],
    },
    "Business / Brand": {
        "callout": "business",
        "label": "Business / Brand",
        "themes": ["KAIJU SYNDICATE", "Antigravity", "dropshipping", "SmartKitchenZone",
