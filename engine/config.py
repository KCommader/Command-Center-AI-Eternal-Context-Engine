...
_YAML_TO_ENV: dict[str, str] = {
    ...
    "search.rerank_min_candidates":      "OMNI_RERANK_MIN_CANDIDATES",
    "search.rerank_cpu_gate":            "OMNI_RERANK_CPU_GATE",
    ...
    "embedding.query_prefix":            "OMNI_EMBED_QUERY_PREFIX",
    "embedding.document_prefix":         "OMNI_EMBED_DOCUMENT_PREFIX",
    "reindex.throttle_ms":               "OMNI_REINDEX_THROTTLE_MS",
